...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(330, 149)
        Dialog.setMinimumSize(QtCore.QSize(330, 149))
        Dialog.setMaximumSize(QtCore.QSize(330, 149))
        ...
        self.line_edit_ip.setMinimumSize(QtCore.QSize(201, 30))
        self.line_edit_ip.setMaximumSize(QtCore.QSize(201, 30))
        font = QtGui.QFont()
        font.setFamily("Google Sans")
        font.setPointSize(10)
        ...
        self.line_edit_port.setMinimumSize(QtCore.QSize(50, 30))
        self.line_edit_port.setMaximumSize(QtCore.QSize(99, 30))
        font = QtGui.QFont()
        font.setFamily("Google Sans")
        font.setPointSize(10)
        ...
        self.button_connect.setMinimumSize(QtCore.QSize(141, 30))
        font = QtGui.QFont()
        font.setFamily("Google Sans")
        font.setPointSize(10)
