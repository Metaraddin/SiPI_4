...
# Form implementation generated from reading ui file 'UI\addEmployeeWindowForm.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.horizontalLayout_4.addWidget(self.line_edit_login)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_head.setText(_translate("Dialog", "ДОБАВИТЬ СОТРУДНИКА"))
        self.label_discipline_4.setText(_translate("Dialog", "ЛОГИН"))
        self.label_discipline.setText(_translate("Dialog", "ПАРОЛЬ"))
